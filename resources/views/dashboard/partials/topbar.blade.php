<nav class="navbar navbar-expand navbar-dark bg-primary topbar mb-0 static-top border-bottom p-0">
    <div class="container">
        ...
        <div class="navbar-nav ml-auto">
            <form action="{{ URL::to('tracking/lacakpaket') }}" method="post" class="d-none d-lg-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search pt-3">
                @csrf
                <div class="input-group">
                    <input type="text" class="form-control bg-light border-0 small" placeholder="CEK POSISI PAKET DASHBOARD" name="no_resi" aria-label="Search" aria-describedby="basic-addon2" />
            ...
            <div class="nav-item dropdown-togle ml-3">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="mt-1 mr-2">
                        ...
                        <p class="mb-0"><small>{{ strtoupper(Auth::user()->nama) }}</small></p>
                    </span>
                </a>
                {{-- Dropdown - User --}}
