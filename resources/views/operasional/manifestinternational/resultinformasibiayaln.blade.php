<div class="row">
    <div class="col-md mb-3">
        ...
        <div class="input-group mb-3" id="resultHargaTransit">
            ...
            <input type="text" min="0" class="form-control" id="harga_transit" name="harga_transit" value="0" onfocus="biaya()" onblur="endBiaya()" required {{ (Auth::user()->role == "admin") ? 'readonly' : '' }}>
        </div>
    ...
    <div class="col-md mb-3">
        ...
        <div>
            <div class="input-group">
                ...
                <input type="text" min="0" class="form-control" id="total_ongkir" name="total_ongkir" value="{{ ($resulthargaongkir->harga_ongkir * $terberat) }}" onfocus="labaKotor()" onblur="endLabaKotor()" required {{ (Auth::user()->role == "admin") ? 'readonly' : '' }}>
            </div>
        </div>
