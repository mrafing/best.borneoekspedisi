        ...
        <div class="container-fluid p-2 p-lg-4 bg-white">
            ...
            <div class="card border-0 mb-4 p-0">
                <div class="card-body p-0">
                    ...
                    <h5 class="mb-0">Update Delivery - <b class="text-danger">Scan bongkar paket sampai</b></h5>
                            ...
                            <div class="col">
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text table-secondary"><i class="fa-solid fa-plus mr-2"></i>Tambah No Karung</span>
                                    </div>
                                    <input class="form-control" maxlength="12" type="text" id="nomor" autofocus autocomplete="off"/>
                                </div>
                            </div>
                        </div>
                    </form>
                    <form action="{{ URL::to('jalurdistribusi/savebongkarpaketsampai') }}" method="post">
                        @csrf
                            ...
                            <table class="table">
                                <thead class="table-secondary">
                                    <tr>
                                        ...
                                        <th><p class="mb-0">NO KARUNG</p></th>
                                    </tr>
                                </thead>
                                <tbody id="tampil">
                                    <input type="hidden" class='form-control form-control-sm' type='text' name='no_karung[]' readonly>
                                </tbody>
                            </table>
                        </div>
...
<script type="text/javascript">
    ...
    function add() {
        ...
        for (var i= tampung_array.length - 1; i>=0 ; i--) {
            html += '<tr><td><p class=\'text-center m-0\'>'+ no +'</p></td><td><input class=\'form-control form-control-sm\' type=\'text\' value=\'' + tampung_array[i] + ' \' name=\' no_karung[] \' readonly></td></tr>';
            no++;
        }
