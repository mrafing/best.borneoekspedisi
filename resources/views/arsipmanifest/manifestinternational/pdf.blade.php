...
<body>
    <h2 style="text-align: center; color: 3d3d3d;">LAPORAN MANIFEST INTERNATIONAL</h2>
        ...
        <tbody>
            ...
            @forelse ( $listmanifest as $data )
                ...
                <tr>
                    ...
                    <td><p style="white-space: nowrap">{{ $data->penerimaLn->kotaLn->kode_kota_ln }}</p></td>
                    <td><p>{{ $data->layanan->nama_layanan }}</p></td>
                    <td><p>{{ $data->pengirim->nama_pengirim }}</p></td>
                    <td><p>{{ $data->penerimaLn->nama_penerima }}</p></td>
                    <td><p>{{ $data->penerimaLn->alamat_penerima }} {{ $data->penerimaLn->kotaLn->nama_kota_ln }}, {{ $data->penerimaLn->kotaLn->negaraLn->nama_negara }}</p></td>
                    ...
                    <td><p>{{ $data->ongkirLn->harga_transit }}</p></td>
                    <td><p>{{ $data->ongkirLn->harga_karantina }}</p></td>
                    <td><p>{{ $data->ongkirLn->harga_packing }}</p></td>
                    <td><p>{{ $data->ongkirLn->total_ongkir }}</p></td>
                    <td><p>{{ $data->ongkirLn->pembayaran }}</p></td>
