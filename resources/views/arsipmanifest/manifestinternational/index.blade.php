...
<script>
    ...
    // Download Pdf //
        $('#pdf').click(function () {
            ...
            let url = '{!! route("pdfmanifestinternational", ["id_outlet_terima" => "__id_outlet_terima__", "id_layanan" => "__id_layanan__", "id_negara_tujuan" => "__id_negara_tujuan__", "dari_tanggal" => "__dari_tanggal__", "sampai_tanggal" => "__sampai_tanggal__", "pembayaran" => "__pembayaran__", "no_resi" => "__no_resi__"]) !!}';
            ...
            url = url.replace('__id_outlet_terima__', id_outlet_terima)
                    ...
                    .replace('__id_negara_tujuan__', id_negara_tujuan)
    ...
    // Download Excel //
        $('#excel').click(function () {
            ...
            // Buat URL dengan query string menggunakan name route
            let url = '{!! route("excelmanifestinternational", ["id_outlet_terima" => "__id_outlet_terima__", "id_layanan" => "__id_layanan__", "id_negara_tujuan" => "__id_negara_tujuan__", "dari_tanggal" => "__dari_tanggal__", "sampai_tanggal" => "__sampai_tanggal__", "pembayaran" => "__pembayaran__", "no_resi" => "__no_resi__"]) !!}';
