            ...
            {{-- CONTENT --}}
                <div class="row">
                    <div class="col-7" style="max-width: 700px">
                        ...
                        <form action="{{ URL::to('arsipmanifest/manifestdomestik/update') }}" method="post">
                            @csrf
                                ...
                                <div class="mb-5">
                                    <div class="row">
                                        <div class="col-sm mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-sm @error('nama_pengirim') is-invalid @enderror" name="nama_pengirim" id="nama_pengirim" value="{{ strtoupper($data->pengirim->nama_pengirim) }}" required>
                                            @error('nama_pengirim')
                                    ...
                                    <div class="row">
                                        <div class="col-sm mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-sm @error('nama_perusahaan_pengirim') is-invalid @enderror" name="nama_perusahaan_pengirim" id="nama_perusahaan_pengirim" value="{{ strtoupper($data->pengirim->nama_perusahaan_pengirim) }}">
                            ...
                            <!-- INFORMASI PENERIMA -->
                                ...
                                <div class="row">
                                    <div class="col-sm mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm @error('nama_penerima') is-invalid @enderror" name="nama_penerima" id="nama_penerima" value="{{ strtoupper($data->penerima->nama_penerima) }}" required>
                                        @error('nama_penerima')
                                ...
                                <div class="row">
                                    <div class="col-sm mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm @error('nama_perusahaan_penerima') is-invalid @enderror" name="nama_perusahaan_penerima" id="nama_perusahaan_penerima" value="{{ strtoupper($data->penerima->nama_perusahaan_penerima) }}">
                                    ...
                                    <div class="col-sm mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm @error('no_penerima') is-invalid @enderror" name="no_penerima" id="no_penerima" value="{{ $data->penerima->no_penerima }}" required>
                                        @error('no_penerima')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm mb-2">
                                        <label for="">Kecamatan, Kota tujuan</label>
                                        <input type="text" class="form-control form-control-sm" value="{{ strtoupper($data->penerima->kecamatan->kota->provinsi->nama_provinsi) . "/" . strtoupper($data->penerima->kecamatan->kota->nama_kota) . "/" . strtoupper($data->penerima->kecamatan->nama_kecamatan) }}" readonly>
                                        {{-- <input type="hidden" name="id_kecamatan_penerima" value="{{ $data->penerima->id_kecamatan_penerima }}"> --}}
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm mb-2">
                                        <label for="alamat_penerima" class="form-label"><span class="text-danger">*</span> Detail Alamat</label>
                                        <textarea class="form-control form-control-sm @error('alamat_penerima') is-invalid @enderror" name="alamat_penerima" id="alamat_penerima" cols="10" rows="1" required>{{ $data->penerima->alamat_penerima }}</textarea>
                            ...
                            <!-- INFORMASI BARANG KIRIMAN -->
                                ...
                                <div class="row">
                                    <div class="col-sm mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="isi" id="isi" value="{{ strtoupper($data->barang->isi) }}" required>
                                    </div>
                                    <div class="col-sm mb-2">
                                        ...
                                        <select class="form-control form-control-sm" name="pembayaran" id="pembayaran" required>
                                            <option value="CASH" {{ ($data->ongkir->pembayaran == "CASH") ? 'selected' : '' }} >CASH</option>
                                            <option value="TRANSFER" {{ ($data->ongkir->pembayaran == "TRANSFER") ? 'selected' : '' }}>TRANSFER</option>
                                            <option value="TRANSFER (LUNAS)" {{ ($data->ongkir->pembayaran == "TRANSFER (LUNAS)") ? 'selected' : '' }}>TRANSFER (LUNAS)</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm mb-2">
                                        ...
                                        <textarea class="form-control form-control-sm" name="informasi_tambahan" id="informasi_tambahan" rows="3">{{ strtoupper($data->barang->informasi_tambahan) }}</textarea>
                                    </div>
                                </div>
